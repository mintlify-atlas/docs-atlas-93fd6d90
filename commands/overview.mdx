...
| `what's up` / `how are you` | Random friendly response from a preset list |
...
| `time` | Speak the current time in 12-hour format (e.g. "02 45 PM") |
| `date` | Speak the current date (e.g. "Monday, June 09, 2025") |
| `mail` / `email` | Start the email flow — Jarvis asks for recipient and message body |
