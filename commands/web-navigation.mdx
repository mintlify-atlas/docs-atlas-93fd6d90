...
Both `open_url()` calls in `actions.py` and `Jarvis2.py` use `webbrowser.open()` to launch the URL in whatever your operating system considers the default browser:
