---
title: "Get Started with Desktop Assistant in 5 Minutes"
...
| `What's up` / `How are you` | Replies with a random upbeat message |
| `Open Google` / `Open YouTube` | Opens the site in your default browser |
| `Search Google for <query>` | Searches Google (or your configured engine) for the query |
